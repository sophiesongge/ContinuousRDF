...
public class RDFTopology{
	...
	public static void main(String[] args) throws Exception{
			...
			while (iter.hasNext()) {
			    ...
			    boolean query1 = (subject.toString().contains("GraduateStudent")) && predicate.toString().contains("takesCourse");
			    
			    //boolean query3 = (subject.toString().contains("")) && predicate.toString().contains("publicationAuthor");
