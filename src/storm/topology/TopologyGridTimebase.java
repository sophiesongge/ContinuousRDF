...
public class TopologyGridTimebase {
	...
	public static void stormCall(String TopologyName, int NumberofWorkers, String JoinType, boolean isLocal)
			throws Exception

	{
		...
		if (JoinType.equalsIgnoreCase("MV")) {
			...
			builder.setBolt("bolt_builder1", new BoltBuilderGridTimebase("Paper", "kNN"), 2)
					.shuffleGrouping("spout_paper");
			builder.setBolt("bolt_prober1", new BoltProberGridTimebase("MV", "WORK", "ANY"), 3)
					.shuffleGrouping("spout_work").shuffleGrouping("bolt_builder1").shuffleGrouping("bolt_prober2");
			builder.setBolt("bolt_prober2", new BoltProberGridTimebase("MV", "Diplome", "ANY"), 3)
					.shuffleGrouping("spout_diplome").allGrouping("bolt_builder1").allGrouping("bolt_prober1");
			...
			builder.setBolt("bolt_builder1", new BoltBuilderGridTimebase("Paper", "kNN"), 2)
					.shuffleGrouping("spout_paper");
			builder.setBolt("bolt_builder2", new BoltBuilderGridTimebase("Work", "INRIA"), 2)
					.shuffleGrouping("spout_work");
			builder.setBolt("bolt_prober", new BoltProberGridTimebase("2V", "Diplome", "ANY"), 3)
					.shuffleGrouping("spout_diplome").allGrouping("bolt_builder1").allGrouping("bolt_builder2");
			...
			builder.setBolt("bolt_builder2", new BoltBuilderGridTimebase("Work", "INRIA"), 2)
					.shuffleGrouping("spout_work");
			builder.setBolt("bolt_prober", new BoltProberGridTimebase("1V", "Diplome", "PhD"), 3)
					.shuffleGrouping("spout_diplome").allGrouping("bolt_builder1").allGrouping("bolt_builder2");
